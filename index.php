				...
				<div class="d-flex justify-content-center form_container">
					<form>
						<div class="input-group mb-3">
							...
							<input type="text" name="abc" class="form-control input_user" value="" placeholder="username" required>
						</div>
						...
						<div class="input-group mb-2">
							...
							<input type="password" name="cbx" value="" placeholder="password" required>
						</div>
